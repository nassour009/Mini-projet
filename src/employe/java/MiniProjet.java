...
class Salaires {
    public static void main(String[] args) {
        ...
        p.ajouterEmploye(new Vendeur("95B001KL", "Ali", "Bello", 45, "1995", 30000));
        p.ajouterEmploye(new Representant("01B005KL", "Léon", "Bertran", 25, "2001", 20000));
        p.ajouterEmploye(new Technicien("95B025KL ", "Ben", "Abdou", 28, "1998", 1000));
        p.ajouterEmploye(new Manutentionnaire("98B001KL", "Jack", "Baueut", 32, "1998", 45));
        p.ajouterEmploye(new TechnARisque("00B012KL", "Jean", "Flippe", 28, "2000", 1000));
        p.ajouterEmploye(new ManutARisque("01B005KL", "Kail", "Abiati", 30, "2001", 45));
